...
{
    const int CON_TIMEOUT = 5;
    mysql_options(m_mysql,MYSQL_OPT_CONNECT_TIMEOUT,(char*)&CON_TIMEOUT);
    
    /*const int RECV_TIMEOUT = 1800;
    mysql_options(m_mysql,MYSQL_OPT_READ_TIMEOUT ,(char*)&RECV_TIMEOUT);*/
...
uint32 CDatabaseSql::InsertId()
{
    return (uint32)mysql_insert_id(m_mysql);
}
